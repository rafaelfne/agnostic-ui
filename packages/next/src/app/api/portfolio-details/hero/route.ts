...
import { GET_PORTFOLIO_HERO_CONTROLLER_TOKEN } from '../../../../infra/di/generated/tokens';
...
export async function GET(request: Request): Promise<Response> {
  try {
    ...
    return await requestContainer.resolve(GET_PORTFOLIO_HERO_CONTROLLER_TOKEN).handle(request);
  } catch {
